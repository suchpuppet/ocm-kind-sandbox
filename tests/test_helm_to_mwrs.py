...
class TestBuildFeedbackForManifest:
    ...
    def test_service_feedback(self):
        ...
        manifest = {"apiVersion": "v1", "kind": "Service", "metadata": {"name": "test-svc", "namespace": "default"}}
        feedback = build_feedback_for_manifest(manifest)
...
class TestExtractCrdResources:
    ...
    def test_extract_multiple_crds(self):
        ...
        manifests = [
            ...
            },
            {
                "apiVersion": "apiextensions.k8s.io/v1",
                "kind": "CustomResourceDefinition",
                "spec": {"group": "example.com", "names": {"plural": "gadgets"}},
            },
            {
                "apiVersion": "apiextensions.k8s.io/v1",
                "kind": "CustomResourceDefinition",
                "spec": {"group": "other.io", "names": {"plural": "things"}},
            },
        ]
    ...
    def test_no_crds(self):
        """Test with no CRDs."""
        manifests = [{"apiVersion": "v1", "kind": "Service"}, {"apiVersion": "apps/v1", "kind": "Deployment"}]
...
class TestCreateRbacManifests:
    ...
    def test_create_rbac(self):
        ...
        rbac_rules = {"example.com": {"resources": {"widgets", "gadgets"}, "verbs": {"get", "list", "create"}}}
